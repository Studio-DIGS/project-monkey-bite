#ifndef LIGHTING_CEL_SHADED_LEAVESINCLUDED
#define LIGHTING_CEL_SHADED_LEAVESINCLUDED
...
void LightingCelShadedLeaves_float(float Smoothness,
      ...
      float EdgeShadowAttenuation, float EdgeRim, float Reflectivity, out float3 Color) {
   ...
   for (int i = 0; i < pixelLightCount; i++) {
      light = GetAdditionalLight(i, Position, 1);
       Color += CalculateCelShading(light, s) / Reflectivity;
   }
