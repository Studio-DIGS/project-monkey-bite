...
public class RunFinishMenuManager : MonoBehaviour
{
    ...
    [ColorHeader("Listening - On Menu Scene Ready", ColorHeaderColor.ListeningChannels)] 
    [SerializeField] private VoidEventChannelSO onRunFinishSceneReady;
    
    [ColorHeader("Invoking - Ask Input State Change", ColorHeaderColor.ListeningChannels)] 
    [SerializeField] private InputStateEventChannelSO askInputStateChange;

    [ColorHeader("Invoking - On Continue Button Pressed", ColorHeaderColor.ListeningChannels)] 
    [SerializeField] private VoidEventChannelSO onContinueButtonPressed;
    
    [ColorHeader("Invoking - On Main Menu Button Pressed", ColorHeaderColor.ListeningChannels)] 
