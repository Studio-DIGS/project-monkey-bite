...
{
    [CustomPropertyDrawer(typeof(BoundSliderAttribute))]
    public class BoundSliderDrawer : PropertyDrawer
    {
        ...
        {
            BoundSliderAttribute bound = (BoundSliderAttribute)attribute;
            ...
            {
                EditorGUI.MinMaxSlider(sliderRect, ref minVal, ref maxVal, bound.min, bound.max);
                ...
                // Clamp values
                minVal = Mathf.Clamp(minVal, bound.min, maxVal);
                maxVal = Mathf.Clamp(maxVal, minVal, bound.max);
            }
